...
describe("extractEmbeddedRoot", () => {
	...
	test("embeds concise execution reporting guidance for delegated workers", async () => {
		...
		expect(commandRunner).toContain("Run the required build or reinstall step next");
		...
		expect(commandRunner).toContain("first clean-context global import proof");
		...
		expect(engineer).toContain("first clean-context global import proof");
		...
		expect(engineer).toContain("Ask for the required build or reinstall step next");
		expect(engineer).toContain("after the next rebuild or reinstall");
